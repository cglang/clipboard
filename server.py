...
# class Server(TcpSocket):
    # def __init__(self, socket, bytehandle):
    #     super().__init__(self, socket, bytehandle)
...
#                 client_id, client_name, group_id, conn))
...
#         for connection in self.connections.values():
#             TcpSocket.send_dict(
#                 connection.conn, {'msg_type': 'client_dict', 'msg': client_dict})
...
#         TcpSocket.send_dict(target_connection, {
#                             'msg_type': 'text', 'msg': data})
